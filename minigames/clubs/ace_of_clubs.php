...
<head>
  <meta charset="UTF-8">
  <title>Ace of Clubs - Brinth</title>
  ...
  <style>
    ...
    .card-front {
      background: url('../../brinth_icons/cardclub.webp') center/cover no-repeat;
    }

    .card-back {
      background: url('../../brinth_icons/ace_of_clubs_hint.png') center/cover no-repeat;
      transform: rotateY(180deg);
    }
...
<body>
  <div class="page-container">
    <div class="page-title">Ace of Clubs</div>
