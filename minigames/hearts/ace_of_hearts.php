...
<head>
  <meta charset="UTF-8">
  <title>Ace of Hearts - Brinth</title>
  ...
  <style>
    ...
    .card-front {
      background: url('../../brinth_icons/cardheart.webp') center/cover no-repeat;
    }

    .card-back {
      background: url('../../brinth_icons/ace_of_hearts_hint.png') center/cover no-repeat;
      transform: rotateY(180deg);
    }
...
<body>
  <div class="page-container">
    <div class="page-title">Ace of Hearts</div>
