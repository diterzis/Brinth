...
<body>
  <div class="page-container">
    <div class="page-title">Illegal Entry</div>
    <div class="message-box">
      <p>Okay you're smart.<br><br>
        Or we just have a bug in the site.<br><br>
        But your total xp ain't enough for you to compete the game you have chosen.<br><br>
        Please, try again after winning some games and earned more experience points!<br><br><br>
        We'll be waiting!</p>
    </div>
