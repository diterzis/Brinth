...
<head>
  <meta charset="UTF-8">
  <title>Ace of Spades - Brinth</title>
  ...
  <style>
    ...
    .card-front {
      background: url('../../brinth_icons/cardspade.webp') center/cover no-repeat;
    }

    .card-back {
      background: url('../../brinth_icons/ace_of_spades_hint.png') center/cover no-repeat;
      transform: rotateY(180deg);
    }
...
<body>
  <div class="page-container">
    <div class="page-title">Ace of Spades</div>
    ...
    <div class="message-paragraph">
      The card is yours.<br>
      Claim your hint by clicking on the card.
    </div>
